...
(null,'Movieflix','Mar-2021','Gestión de un sistema de vídeo en streaming','Este proyecto desarrolla la plataforma para gestionar y administrar, tanto las películas a visionar vía streaming como los usuarios inscritos.\r\nEs por ello, que el proyecto se centra en la zona de administración donde se ofrece la gestión de usuario y de películas, proporcionando una serie de informes.\r\n\r\n\r\n','img/proyectos/movieflix.jpg',1),
...
(null,'Aprende Aleman','Diciembre-20','Aplicación móvil para aprender Alemán.','Esta aplicación fue desarrollada para aquellos que quieran estudiar Alemán obtener conocimientos básicos de Alemán Conversacional con rapidez, memoriza palabras y de forma gratuita!\r\nEl contenido está siendo desarrollado por los principales especialistas en metodología y lingüistas, que enseñan en universidades.\r\n','img/proyectos/aprender aleman.jpg',1),
(null,'Linio','Febrero-21','La tienda online más completa que puedas encontrar.','Es tu mejor opción para tus compras en línea. Contamos con las mejores marcas originales en la tienda más grande y confiable de todo el mundo. Busca tus tiendas favoritas en cualquier momento y recibe tú producto donde quieras.\r\n\r\nExplora entre todas las categorías de productos que tenemos y descubre exclusivos descuentos en la aplicación. Navega en la app y encuentra los productos que buscas. Escoge lo que más te gusta entre las ofertas que tenemos para ti. \r\n','img/proyectos/linio.jpg',1),
(null,'CaixaBankiAbanCajamarLiberbankinterBanestOpen','Abril-2025','Web unificada de los bancos de España','Web que centraliza todos los servicios de todos los bancos de España. El usuario puede acceder a todos los productos que ofrecen los diferentes bancos, además de realizar operaciones a través de una capa segura para cada api de cada banco','img/proyectos/5.jpg',1),
